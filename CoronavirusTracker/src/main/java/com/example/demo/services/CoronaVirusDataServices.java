...
@Service
public class CoronaVirusDataServices<HttpClient, HttpRequest, CSVRecord> 
{
	...
	HttpResource<String>httpResponse=client.send(request, HttpRange.BodyHandlers.ofString());
	
	StringReader csvBodyreader=new StringReader(httpResponse.body());
	Iterable<CSVRecord> records = ChoiceFormat.DEFAULT.withFirstRecordAsHeader().parse(csvBodyreader);
